...
public class Audio {
	 ...
	 */
	public static void play(File f) throws Exception{
	 ...
	 */
	private static void convertFormat(AudioFormat audioFormat, AudioInputStream audioStream ){
	 ...
	 */
	public static synchronized void setMicrosecondPosition(long seek){
		if(clip != null){
	 ...
	 */
	public static void setPan(int value) throws Exception{
        if (clip != null) {
	 ...
	 * @return retourne true si il est valide
	 */
	private static boolean isUlaw(File f) {
		try {
	 ...
	 * @return retourne true si il est valide
	 */
	private static boolean isAlaw(File f) {
		try {
			Encoding enc = AudioSystem.getAudioFileFormat(f).getFormat().getEncoding();
	 ...
	 * @return retourne true si il est valide
	 */
	private static boolean isPcm(File f) {
		if (f == null)
			return false;
		try {
			Encoding enc = AudioSystem.getAudioFileFormat(f).getFormat().getEncoding();
